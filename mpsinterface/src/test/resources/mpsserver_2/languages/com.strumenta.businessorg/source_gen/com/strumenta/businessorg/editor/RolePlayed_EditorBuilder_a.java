...
/*package*/ class RolePlayed_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RolePlayed_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_i5d4n5_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.role$LfTF;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.role$LfTF);
    }
