...
/*package*/ class Person_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_n1xayz_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new rolesListHandler_n1xayz_c0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Horizontal(), false);
    editorCell.setCellId("refNodeList_roles");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class rolesListHandler_n1xayz_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public rolesListHandler_n1xayz_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(rolesListHandler_n1xayz_c0.this.getNode(), LINKS.roles$44WJ));
      try {
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink roles$44WJ = MetaAdapterFactory.getContainmentLink(0x96ad5b8f04fe4e16L, 0xa7d60e014b8726e4L, 0x4923b41015868b9aL, 0x4923b41015880fafL, "roles");
  }
}
